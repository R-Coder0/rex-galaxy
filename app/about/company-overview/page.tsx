  ...
  return (
    ...
    <div className="min-h-screen bg-slate-900 text-gray-100 overflow-hidden">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/about/aboutbanner.webp')" }}
      >
      ...
      {/* Call to Action */}
      <section className="border-b-2 border-gray-500 py-20 bg-slate-900">
        <div className="container mx-auto px-6 text-center">
          <div
            ref={cta.elementRef}
            className={`max-w-4xl mx-auto transition-all duration-1000 ease-out ${cta.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'
              }`}
          >
            <h2 className="text-4xl font-bold mb-6 text-gray-100">
              Ready to Transform Your
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-200"> Digital Future?</span>
            </h2>
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Let&#39;s discuss how RexGalaxy can help accelerate your business growth through innovative technology solutions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border-2 border-orange-500 text-orange-500 px-8 py-4 rounded-lg font-semibold hover:bg-orange-500 hover:text-white transition-all duration-300 transform hover:scale-105">
