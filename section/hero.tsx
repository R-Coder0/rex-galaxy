...
type Slide = {
  id: number;
  desktop: string; // shown at md and up
  mobile: string;  // shown below md
  title: string;
  subtitle: string;
};
...
const HeroSection: React.FC = () => {
  ...
  // 1) Give each slide a desktop and a mobile image
  const sliderImages: Slide[] = [
    {
      id: 1,
      desktop: "/slider/1.png",
      mobile: "/slider/mobile/1.png",
      title: "Modern Workspace",
      subtitle: "Where Innovation Happens",
    },
    {
      id: 2,
      desktop: "/slider/3.png",
      mobile: "/slider/mobile/2.png",
      title: "Digital Solutions",
      subtitle: "Transforming Business Ideas",
    },
    {
      id: 3,
      desktop: "/slider/2.png",
      mobile: "/slider/mobile/3.png",
...
<div className="relative h-[70vh] md:h-[80vh] overflow-hidden">
        {/* 2) Use <picture> to swap sources by breakpoint */}
        ...
        <button
          onClick={prevSlide}
          className="absolute left-4 top-1/2 -translate-y-1/2 transform rounded-full bg-white/10 p-2 backdrop-blur-sm transition-colors hover:bg-white/20 md:left-6 md:p-3"
        ...
        <button
          onClick={nextSlide}
          className="absolute right-4 top-1/2 -translate-y-1/2 transform rounded-full bg-white/10 p-2 backdrop-blur-sm transition-colors hover:bg-white/20 md:right-6 md:p-3"
        ...
        {/* Slider Dots */}
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 transform md:bottom-8">
